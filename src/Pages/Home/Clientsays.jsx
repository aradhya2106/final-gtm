      ...
      <div className="client_say_all_container">
        <div>
          <Container className="Rodriguez_container">
            <Typography className="Rodriguez_text"> Rodriguez</Typography>
            <Typography className="Techc_corp_text">CEO, TechCorp</Typography>
            <Typography className="Gtm_lab_Text">
        ...
        <div>
          <Container  className="Mari_Garcia_container">
            <Typography className="Rodriguez_text"> Maria Garcia</Typography>
            <Typography className="Techc_corp_text">
              Founder, StartupXYZ
            </Typography>
            <Typography className="maria_Text">
        ...
        <div>
          <Container className="Rodriguez_container">
            <Typography className="Rodriguez_text"> David Kim</Typography>
            <Typography className="Techc_corp_text">
              CTO, InnovateLab
            </Typography>
            <Typography className="Gtm_lab_Text">
